...
const founder = {
  ...
  role: "Founder · Sacred Guide · Frequency Practitioner",
...
const network = [
  { t: "Energy Practitioners", d: "A vetted network of advanced Reiki, Quantum, Pranic, and Theta practitioners across South Florida and beyond." },
  { t: "Sound & Frequency Masters", d: "World-class sound practitioners and frequency specialists brought into the sanctuary for sessions and ceremonies." },
...
const visiting = [
  { t: "Indigenous Shamans", d: "Traditional plant wisdom carriers and ceremonial leaders from South America, Mexico, and other lineages." },
  { t: "Master Energy Practitioners", d: "Internationally recognized practitioners — Pranic, Quantum, Theta, and other advanced modalities." },
...
function PractitionersPage() {
  return (
    <PageShell
      ...
      intro="Soul True is built around William, a curated practitioner network, and an ongoing series of visiting luminaries brought to South Florida to share their wisdom."
    >
      {/* Founder */}
      ...
      <section className="mt-32">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-serif text-4xl font-light text-foreground md:text-5xl">A Curated Circle of Practitioners</h2>
          ...
          <p className="mx-auto mt-8 max-w-2xl text-sm font-light leading-relaxed text-muted-foreground md:text-base">
            Soul True is not a one-person practice. Your customized journey draws from a vetted network of specialists across modalities.
          </p>
        </div>
        <div className="mt-12">
