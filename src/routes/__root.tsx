...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A physical sanctuary for holistic healing, sacred teachings, and the remembrance of hidden truths across realms." },
      { property: "og:title", content: "Sacred Journey — Holistic Wellness & Spiritual Sanctuary" },
      { property: "og:description", content: "A physical sanctuary for holistic healing, sacred teachings, and the remembrance of hidden truths across realms." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { rel: "preconnect", content: "" },
      { name: "twitter:title", content: "Sacred Journey — Holistic Wellness & Spiritual Sanctuary" },
      { name: "twitter:description", content: "A physical sanctuary for holistic healing, sacred teachings, and the remembrance of hidden truths across realms." },
