...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Sacred Journey — Holistic Wellness & Spiritual Guidance" },
      ...
      { property: "og:title", content: "Sacred Journey — Holistic Wellness & Spiritual Guidance" },
      ...
      { name: "twitter:title", content: "Sacred Journey — Holistic Wellness & Spiritual Guidance" },
