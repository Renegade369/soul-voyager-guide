...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Cinzel:wght@400;600;700;900&family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400&family=Courier+Prime:wght@400&family=Inter:wght@300;400;500&family=Outfit:wght@300;400;500;600&family=Rajdhani:wght@300;400;600;700&display=swap" },
    ],
  }),
