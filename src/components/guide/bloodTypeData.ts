...
export const BLOOD_TYPE_PROFILES: Record<string, BloodTypeProfile> = {
  "O+": {
    ...
    exercise: "Intense physical exercise is not optional for O types — it is essential. Running, martial arts, weightlifting, contact sports, cycling, swimming. O types become anxious, unfocused, and depressed without vigorous physical activity. Aim for 4–5 sessions per week of high intensity movement.",
