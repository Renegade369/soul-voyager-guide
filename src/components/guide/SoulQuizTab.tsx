...
const questions: QuizQuestion[] = [
  ...
  { question: "Your greatest gift to others is:", options: [
    { text: "Unconditional love and emotional restoration", types: ["Earth Angel","Crystal Being"] },
  ...
  { question: "You are most drawn to:", options: [
    ...
    { text: "Helping individuals restore their hearts and find their path", types: ["Earth Angel","Lightworker"] },
  ]},
  ...
  { question: "Your mission in this lifetime feels connected to:", options: [
    { text: "Restoration — of people, relationships, and the collective heart", types: ["Earth Angel","Lightworker"] },
...
const results: Record<SoulType, SoulResult> = {
  ...
  "Earth Angel": {
    ...
    mission: "Your presence soothes. People feel safer, calmer, and more loved simply by being near you. Your mission is to hold unconditional love in a world that has forgotten what love truly is.",
    gifts: "Unconditional love, emotional restoration, compassion, energetic presence",
  ...
  "Lightworker": {
    ...
    gifts: "Spiritual teaching, transmission, inspiration, energetic resonance",
  ...
  "Ancient Soul": {
    ...
    gifts: "Deep wisdom, pattern recognition across time, spiritual authority, ancestral restoration",
